...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.S.on(input_qubit[1])) # number=51
    c.append(cirq.H.on(input_qubit[1])) # number=52
    c.append(cirq.H.on(input_qubit[1])) # number=12
    c.append(cirq.CZ.on(input_qubit[0],input_qubit[1])) # number=17
    ...
    c.append(cirq.CNOT.on(input_qubit[2],input_qubit[3])) # number=64
    ...
    c.append(cirq.CNOT.on(input_qubit[2],input_qubit[3])) # number=55
    ...
    c.append(cirq.CNOT.on(input_qubit[1],input_qubit[0])) # number=66
    ...
    c.append(cirq.T.on(input_qubit[0])) # number=59
