...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.T.on(input_qubit[1])) # number=49
    c.append(cirq.T.on(input_qubit[1])) # number=59
    c.append(cirq.T.on(input_qubit[1])) # number=50
    c.append(cirq.T.on(input_qubit[1])) # number=70
    ...
    c.append(cirq.CNOT.on(input_qubit[3],input_qubit[1])) # number=52
    ...
    c.append(cirq.CZ.on(input_qubit[2],input_qubit[3])) # number=60
    c.append(cirq.H.on(input_qubit[3])) # number=61
    c.append(cirq.CNOT.on(input_qubit[2],input_qubit[3])) # number=13
    ...
    c.append(cirq.CZ.on(input_qubit[2],input_qubit[3])) # number=71
    c.append(cirq.H.on(input_qubit[3])) # number=72
    ...
    c.append(cirq.T.on(input_qubit[0])) # number=29
    c.append(cirq.T.on(input_qubit[0])) # number=54
    c.append(cirq.T.on(input_qubit[0])) # number=30
    c.append(cirq.T.on(input_qubit[0])) # number=44
    ...
    c.append(cirq.CNOT.on(input_qubit[1],input_qubit[2])) # number=75
    ...
    c.append(cirq.CZ.on(input_qubit[1],input_qubit[2])) # number=68
