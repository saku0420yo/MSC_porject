...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.T.on(input_qubit[0])) # number=11
    ...
    c.append(cirq.CZ.on(input_qubit[2],input_qubit[1])) # number=45
    ...
    c.append(cirq.CZ.on(input_qubit[2],input_qubit[1])) # number=39
    ...
    c.append(cirq.CZ.on(input_qubit[2],input_qubit[1])) # number=47
    ...
    c.append(cirq.CNOT.on(input_qubit[1],input_qubit[2])) # number=55
