...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.CZ.on(input_qubit[3],input_qubit[1])) # number=65
    ...
    c.append(cirq.SWAP.on(input_qubit[2],input_qubit[3])) # number=10
    ...
    c.append(cirq.S.on(input_qubit[1])) # number=37
    c.append(cirq.T.on(input_qubit[1])) # number=38
    c.append(cirq.T.on(input_qubit[1])) # number=51
