...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.T.on(input_qubit[1])) # number=60
    c.append(cirq.S.on(input_qubit[1])) # number=32
    ...
    c.append(cirq.CNOT.on(input_qubit[3],input_qubit[1])) # number=63
    ...
    c.append(cirq.CZ.on(input_qubit[2],input_qubit[3])) # number=49
    ...
    c.append(cirq.T.on(input_qubit[0])) # number=67
    c.append(cirq.T.on(input_qubit[0])) # number=54
    ...
    c.append(cirq.S.on(input_qubit[1])) # number=42
    ...
    c.append(cirq.CZ.on(input_qubit[1],input_qubit[2])) # number=71
...
if __name__ == '__main__':
    ...
    writefile = open("startCirq_statevector_224.csv","w+")
