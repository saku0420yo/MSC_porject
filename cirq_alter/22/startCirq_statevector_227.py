...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.CZ.on(input_qubit[0],input_qubit[1])) # number=60
    ...
    c.append(cirq.S.on(input_qubit[1])) # number=31
    c.append(cirq.T.on(input_qubit[1])) # number=32
    c.append(cirq.T.on(input_qubit[1])) # number=64
    ...
    c.append(cirq.CNOT.on(input_qubit[2],input_qubit[3])) # number=74
    c.append(cirq.H.on(input_qubit[3])) # number=75
    ...
    c.append(cirq.H.on(input_qubit[3])) # number=65
    c.append(cirq.CNOT.on(input_qubit[2],input_qubit[3])) # number=76
    c.append(cirq.H.on(input_qubit[3])) # number=77
    c.append(cirq.H.on(input_qubit[3])) # number=66
    ...
    c.append(cirq.T.on(input_qubit[0])) # number=53
    c.append(cirq.T.on(input_qubit[0])) # number=78
    c.append(cirq.S.on(input_qubit[0])) # number=54
    ...
    c.append(cirq.CZ.on(input_qubit[0],input_qubit[1])) # number=79
    c.append(cirq.H.on(input_qubit[1])) # number=80
    c.append(cirq.H.on(input_qubit[1])) # number=17
    c.append(cirq.T.on(input_qubit[1])) # number=42
    c.append(cirq.T.on(input_qubit[1])) # number=71
    c.append(cirq.S.on(input_qubit[1])) # number=43
    ...
    c.append(cirq.rz(2.356194490192345).on(input_qubit[2])) # number=9
    ...
    c.append(cirq.CNOT.on(input_qubit[1],input_qubit[2])) # number=56
    ...
    c.append(cirq.CZ.on(input_qubit[1],input_qubit[2])) # number=81
    c.append(cirq.H.on(input_qubit[2])) # number=82
    c.append(cirq.H.on(input_qubit[2])) # number=20
    c.append(cirq.H.on(input_qubit[2])) # number=45
    c.append(cirq.CNOT.on(input_qubit[1],input_qubit[2])) # number=58
...
if __name__ == '__main__':
    ...
    writefile = open("startCirq_statevector_227.csv","w+")
