...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.T.on(input_qubit[1])) # number=31
    c.append(cirq.T.on(input_qubit[1])) # number=72
    ...
    c.append(cirq.CZ.on(input_qubit[0],input_qubit[1])) # number=73
    ...
    c.append(cirq.CNOT.on(input_qubit[2],input_qubit[3])) # number=75
    c.append(cirq.H.on(input_qubit[3])) # number=76
    ...
    c.append(cirq.CZ.on(input_qubit[2],input_qubit[3])) # number=65
    ...
    c.append(cirq.S.on(input_qubit[0])) # number=53
    ...
    c.append(cirq.CZ.on(input_qubit[0],input_qubit[1])) # number=77
    c.append(cirq.H.on(input_qubit[1])) # number=78
    ...
    c.append(cirq.CNOT.on(input_qubit[1],input_qubit[2])) # number=19
    ...
    c.append(cirq.CZ.on(input_qubit[1],input_qubit[2])) # number=79
...
if __name__ == '__main__':
    ...
    writefile = open("startCirq_statevector_231.csv","w+")
