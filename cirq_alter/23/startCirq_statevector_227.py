...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.S.on(input_qubit[1])) # number=53
    c.append(cirq.S.on(input_qubit[1])) # number=54
    ...
    c.append(cirq.CNOT.on(input_qubit[3],input_qubit[1])) # number=22
    ...
    c.append(cirq.CZ.on(input_qubit[2],input_qubit[3])) # number=58
    ...
    c.append(cirq.CNOT.on(input_qubit[2],input_qubit[3])) # number=35
    ...
    c.append(cirq.S.on(input_qubit[0])) # number=38
    c.append(cirq.T.on(input_qubit[0])) # number=39
    c.append(cirq.T.on(input_qubit[0])) # number=64
    ...
    c.append(cirq.S.on(input_qubit[1])) # number=65
    c.append(cirq.S.on(input_qubit[1])) # number=66
    ...
    c.append(cirq.CNOT.on(input_qubit[1],input_qubit[2])) # number=45
    ...
    c.append(cirq.CNOT.on(input_qubit[1],input_qubit[2])) # number=49
