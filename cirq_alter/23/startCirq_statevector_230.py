...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.CZ.on(input_qubit[2],input_qubit[3])) # number=56
    c.append(cirq.H.on(input_qubit[3])) # number=57
    c.append(cirq.CNOT.on(input_qubit[2],input_qubit[3])) # number=34
    ...
    c.append(cirq.T.on(input_qubit[0])) # number=38
    c.append(cirq.T.on(input_qubit[0])) # number=62
    c.append(cirq.S.on(input_qubit[0])) # number=39
    ...
    c.append(cirq.X.on(input_qubit[1])) # number=63
    ...
    c.append(cirq.CNOT.on(input_qubit[1],input_qubit[2])) # number=69
