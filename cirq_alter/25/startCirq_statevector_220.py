...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.CZ.on(input_qubit[3],input_qubit[1])) # number=10
    ...
    c.append(cirq.Z.on(input_qubit[0])) # number=31
    ...
    c.append(cirq.S.on(input_qubit[1])) # number=38
    ...
    c.append(cirq.CNOT.on(input_qubit[1],input_qubit[2])) # number=24
