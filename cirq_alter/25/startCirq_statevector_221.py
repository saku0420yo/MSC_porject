...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.T.on(input_qubit[1])) # number=37
    c.append(cirq.T.on(input_qubit[1])) # number=27
    c.append(cirq.T.on(input_qubit[1])) # number=43
    ...
    c.append(cirq.S.on(input_qubit[0])) # number=30
    ...
    c.append(cirq.CNOT.on(input_qubit[3],input_qubit[1])) # number=44
    ...
    c.append(cirq.T.on(input_qubit[0])) # number=12
    c.append(cirq.T.on(input_qubit[0])) # number=48
    c.append(cirq.S.on(input_qubit[0])) # number=36
    ...
    c.append(cirq.T.on(input_qubit[1])) # number=23
...
if __name__ == '__main__':
    ...
    writefile = open("startCirq_statevector_221.csv","w+")
