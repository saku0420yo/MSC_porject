...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.S.on(input_qubit[0])) # number=34
    c.append(cirq.T.on(input_qubit[0])) # number=35
    c.append(cirq.T.on(input_qubit[0])) # number=58
    ...
    c.append(cirq.T.on(input_qubit[1])) # number=45
    ...
    c.append(cirq.CZ.on(input_qubit[1],input_qubit[2])) # number=46
    ...
    c.append(cirq.CNOT.on(input_qubit[1],input_qubit[2])) # number=62
    ...
    c.append(cirq.CNOT.on(input_qubit[1],input_qubit[2])) # number=64
