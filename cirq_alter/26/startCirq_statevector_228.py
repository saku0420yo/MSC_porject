...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.S.on(input_qubit[1])) # number=41
    ...
    c.append(cirq.S.on(input_qubit[0])) # number=48
    c.append(cirq.S.on(input_qubit[0])) # number=49
    ...
    c.append(cirq.T.on(input_qubit[1])) # number=38
    ...
    c.append(cirq.CNOT.on(input_qubit[1],input_qubit[2])) # number=53
