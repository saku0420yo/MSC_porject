...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.S.on(input_qubit[3])) # number=39
    c.append(cirq.S.on(input_qubit[3])) # number=40
    ...
    c.append(cirq.CZ.on(input_qubit[3],input_qubit[1])) # number=42
    ...
    c.append(cirq.Z.on(input_qubit[0])) # number=35
