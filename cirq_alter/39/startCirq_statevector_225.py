...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.T.on(input_qubit[0])) # number=22
    c.append(cirq.H.on(input_qubit[0])) # number=14
    c.append(cirq.rx(-1.1152653920243765).on(input_qubit[3])) # number=10
    ...
    c.append(cirq.S.on(input_qubit[1])) # number=52
    ...
    c.append(cirq.CZ.on(input_qubit[1],input_qubit[2])) # number=38
