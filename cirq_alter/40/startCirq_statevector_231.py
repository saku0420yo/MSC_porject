...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.T.on(input_qubit[3])) # number=13
    c.append(cirq.T.on(input_qubit[3])) # number=20
    c.append(cirq.T.on(input_qubit[3])) # number=14
    c.append(cirq.T.on(input_qubit[3])) # number=21
    ...
    c.append(cirq.CZ.on(input_qubit[3],input_qubit[1])) # number=55
    ...
    c.append(cirq.T.on(input_qubit[0])) # number=16
    c.append(cirq.T.on(input_qubit[0])) # number=48
    c.append(cirq.T.on(input_qubit[0])) # number=24
    c.append(cirq.T.on(input_qubit[0])) # number=40
    ...
    c.append(cirq.S.on(input_qubit[1])) # number=33
    ...
    c.append(cirq.CNOT.on(input_qubit[1],input_qubit[2])) # number=61
