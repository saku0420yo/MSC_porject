...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.S.on(input_qubit[1])) # number=26
    ...
    c.append(cirq.S.on(input_qubit[3])) # number=18
    c.append(cirq.T.on(input_qubit[3])) # number=19
    ...
    c.append(cirq.CNOT.on(input_qubit[3],input_qubit[1])) # number=4
    ...
    c.append(cirq.S.on(input_qubit[0])) # number=14
    ...
    c.append(cirq.S.on(input_qubit[1])) # number=34
    c.append(cirq.S.on(input_qubit[1])) # number=35
    ...
    c.append(cirq.CZ.on(input_qubit[1],input_qubit[2])) # number=37
    c.append(cirq.H.on(input_qubit[2])) # number=38
    c.append(cirq.H.on(input_qubit[2])) # number=24
    c.append(cirq.CZ.on(input_qubit[1],input_qubit[2])) # number=39
