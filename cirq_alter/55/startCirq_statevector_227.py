...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.T.on(input_qubit[1])) # number=15
    c.append(cirq.T.on(input_qubit[1])) # number=60
    c.append(cirq.S.on(input_qubit[1])) # number=49
    ...
    c.append(cirq.CNOT.on(input_qubit[3],input_qubit[2])) # number=61
    ...
    c.append(cirq.CZ.on(input_qubit[3],input_qubit[2])) # number=52
    ...
    c.append(cirq.T.on(input_qubit[0])) # number=19
    c.append(cirq.T.on(input_qubit[0])) # number=30
    c.append(cirq.T.on(input_qubit[0])) # number=20
    ...
    c.append(cirq.T.on(input_qubit[1])) # number=65
    c.append(cirq.T.on(input_qubit[1])) # number=34
    c.append(cirq.T.on(input_qubit[1])) # number=66
    ...
    c.append(cirq.CZ.on(input_qubit[1],input_qubit[2])) # number=56
