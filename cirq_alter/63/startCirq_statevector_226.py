...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.CZ.on(input_qubit[3],input_qubit[1])) # number=16
    c.append(cirq.H.on(input_qubit[1])) # number=17
    c.append(cirq.CNOT.on(input_qubit[3],input_qubit[1])) # number=8
    c.append(cirq.CNOT.on(input_qubit[3],input_qubit[1])) # number=18
    c.append(cirq.CNOT.on(input_qubit[3],input_qubit[1])) # number=19
