...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.CNOT.on(input_qubit[2],input_qubit[1])) # number=49
    ...
    c.append(cirq.CZ.on(input_qubit[2],input_qubit[1])) # number=51
    c.append(cirq.H.on(input_qubit[1])) # number=52
    c.append(cirq.CNOT.on(input_qubit[2],input_qubit[1])) # number=24
