...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.CNOT.on(input_qubit[3],input_qubit[1])) # number=34
    ...
    c.append(cirq.CNOT.on(input_qubit[2],input_qubit[3])) # number=52
    ...
    c.append(cirq.CZ.on(input_qubit[2],input_qubit[3])) # number=44
    c.append(cirq.H.on(input_qubit[3])) # number=45
    c.append(cirq.H.on(input_qubit[3])) # number=14
    c.append(cirq.CZ.on(input_qubit[2],input_qubit[3])) # number=26
    c.append(cirq.H.on(input_qubit[3])) # number=27
    c.append(cirq.H.on(input_qubit[3])) # number=15
    c.append(cirq.CZ.on(input_qubit[2],input_qubit[3])) # number=46
    ...
    c.append(cirq.CZ.on(input_qubit[1],input_qubit[2])) # number=60
