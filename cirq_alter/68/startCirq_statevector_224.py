...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.CNOT.on(input_qubit[3],input_qubit[1])) # number=33
    ...
    c.append(cirq.CNOT.on(input_qubit[2],input_qubit[3])) # number=25
    c.append(cirq.H.on(input_qubit[3])) # number=10
    c.append(cirq.CZ.on(input_qubit[2],input_qubit[3])) # number=55
    ...
    c.append(cirq.CNOT.on(input_qubit[2],input_qubit[3])) # number=39
    ...
    c.append(cirq.S.on(input_qubit[0])) # number=61
    c.append(cirq.S.on(input_qubit[0])) # number=62
    ...
    c.append(cirq.CNOT.on(input_qubit[1],input_qubit[2])) # number=51
