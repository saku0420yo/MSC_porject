...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.CNOT.on(input_qubit[3],input_qubit[1])) # number=23
    ...
    c.append(cirq.CNOT.on(input_qubit[2],input_qubit[3])) # number=18
    ...
    c.append(cirq.CZ.on(input_qubit[2],input_qubit[3])) # number=27
    ...
    c.append(cirq.S.on(input_qubit[1])) # number=39
    c.append(cirq.S.on(input_qubit[1])) # number=40
    ...
    c.append(cirq.CNOT.on(input_qubit[1],input_qubit[2])) # number=42
    c.append(cirq.CNOT.on(input_qubit[1],input_qubit[2])) # number=43
...
if __name__ == '__main__':
    ...
    writefile = open("startCirq_statevector_225.csv","w+")
