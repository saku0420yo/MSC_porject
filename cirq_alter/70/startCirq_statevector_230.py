...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.T.on(input_qubit[3])) # number=12
    c.append(cirq.T.on(input_qubit[3])) # number=22
    c.append(cirq.T.on(input_qubit[3])) # number=13
    c.append(cirq.T.on(input_qubit[3])) # number=27
    ...
    c.append(cirq.S.on(input_qubit[0])) # number=5
    ...
    c.append(cirq.S.on(input_qubit[1])) # number=23
