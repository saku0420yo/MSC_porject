...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.CNOT.on(input_qubit[3],input_qubit[1])) # number=39
    ...
    c.append(cirq.T.on(input_qubit[0])) # number=7
    c.append(cirq.T.on(input_qubit[0])) # number=25
    c.append(cirq.T.on(input_qubit[0])) # number=15
    ...
    c.append(cirq.S.on(input_qubit[0])) # number=41
    c.append(cirq.S.on(input_qubit[0])) # number=42
    ...
    c.append(cirq.Z.on(input_qubit[3])) # number=11
    ...
    c.append(cirq.CNOT.on(input_qubit[1],input_qubit[2])) # number=48
    ...
    c.append(cirq.CNOT.on(input_qubit[1],input_qubit[2])) # number=35
