...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.CNOT.on(input_qubit[3],input_qubit[2])) # number=40
    ...
    c.append(cirq.S.on(input_qubit[0])) # number=44
    c.append(cirq.S.on(input_qubit[0])) # number=45
    ...
    c.append(cirq.CZ.on(input_qubit[2],input_qubit[0])) # number=32
