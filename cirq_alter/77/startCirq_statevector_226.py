...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.T.on(input_qubit[1])) # number=55
    ...
    c.append(cirq.CZ.on(input_qubit[3],input_qubit[1])) # number=58
    ...
    c.append(cirq.H.on(input_qubit[3])) # number=3
    ...
    c.append(cirq.CNOT.on(input_qubit[2],input_qubit[3])) # number=62
    ...
    c.append(cirq.CNOT.on(input_qubit[1],input_qubit[0])) # number=64
    ...
    c.append(cirq.T.on(input_qubit[0])) # number=26
    c.append(cirq.T.on(input_qubit[0])) # number=54
    c.append(cirq.T.on(input_qubit[0])) # number=27
    c.append(cirq.T.on(input_qubit[0])) # number=41
    ...
    c.append(cirq.T.on(input_qubit[1])) # number=17
    ...
    c.append(cirq.CNOT.on(input_qubit[1],input_qubit[2])) # number=50
    c.append(cirq.H.on(input_qubit[2])) # number=51
    c.append(cirq.CZ.on(input_qubit[1],input_qubit[2])) # number=66
