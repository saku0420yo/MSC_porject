...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.T.on(input_qubit[3])) # number=36
    c.append(cirq.T.on(input_qubit[3])) # number=25
    c.append(cirq.T.on(input_qubit[3])) # number=37
    ...
    c.append(cirq.CNOT.on(input_qubit[3],input_qubit[1])) # number=27
    ...
    c.append(cirq.S.on(input_qubit[0])) # number=31
