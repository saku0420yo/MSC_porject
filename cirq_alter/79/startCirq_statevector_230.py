...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.S.on(input_qubit[3])) # number=27
    c.append(cirq.S.on(input_qubit[3])) # number=28
    ...
    c.append(cirq.T.on(input_qubit[0])) # number=42
    c.append(cirq.T.on(input_qubit[0])) # number=33
    c.append(cirq.T.on(input_qubit[0])) # number=43
