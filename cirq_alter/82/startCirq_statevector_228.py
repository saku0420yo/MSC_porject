...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.CZ.on(input_qubit[1],input_qubit[3])) # number=42
    c.append(cirq.H.on(input_qubit[3])) # number=43
    c.append(cirq.H.on(input_qubit[3])) # number=17
    c.append(cirq.CZ.on(input_qubit[1],input_qubit[3])) # number=26
    ...
    c.append(cirq.CZ.on(input_qubit[1],input_qubit[2])) # number=30
