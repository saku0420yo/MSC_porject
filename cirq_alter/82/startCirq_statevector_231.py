...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.CZ.on(input_qubit[0],input_qubit[1])) # number=69
    c.append(cirq.H.on(input_qubit[1])) # number=70
    c.append(cirq.H.on(input_qubit[1])) # number=44
    c.append(cirq.S.on(input_qubit[1])) # number=56
    c.append(cirq.S.on(input_qubit[1])) # number=57
    ...
    c.append(cirq.CZ.on(input_qubit[0],input_qubit[1])) # number=59
    ...
    c.append(cirq.CZ.on(input_qubit[3],input_qubit[1])) # number=48
    ...
    c.append(cirq.T.on(input_qubit[0])) # number=13
    c.append(cirq.T.on(input_qubit[0])) # number=24
    c.append(cirq.T.on(input_qubit[0])) # number=14
    c.append(cirq.T.on(input_qubit[0])) # number=25
    c.append(cirq.H.on(input_qubit[0])) # number=15
    c.append(cirq.CNOT.on(input_qubit[1],input_qubit[3])) # number=10
    ...
    c.append(cirq.CZ.on(input_qubit[1],input_qubit[3])) # number=75
    c.append(cirq.H.on(input_qubit[3])) # number=76
    c.append(cirq.H.on(input_qubit[3])) # number=62
    ...
    c.append(cirq.H.on(input_qubit[3])) # number=63
    c.append(cirq.CZ.on(input_qubit[1],input_qubit[3])) # number=77
    c.append(cirq.H.on(input_qubit[3])) # number=78
    c.append(cirq.H.on(input_qubit[3])) # number=64
    ...
    c.append(cirq.CNOT.on(input_qubit[1],input_qubit[2])) # number=65
    ...
    c.append(cirq.CNOT.on(input_qubit[1],input_qubit[2])) # number=52
