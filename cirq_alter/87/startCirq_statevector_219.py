...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.T.on(input_qubit[0])) # number=10
    ...
    c.append(cirq.CZ.on(input_qubit[3],input_qubit[2])) # number=19
    ...
    c.append(cirq.CNOT.on(input_qubit[1],input_qubit[2])) # number=23
