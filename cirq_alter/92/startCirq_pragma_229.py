...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.T.on(input_qubit[1])) # number=8
    c.append(cirq.T.on(input_qubit[1])) # number=13
    c.append(cirq.T.on(input_qubit[1])) # number=9
    c.append(cirq.T.on(input_qubit[1])) # number=30
    c.append(cirq.H.on(input_qubit[1])) # number=10
    c.append(cirq.H.on(input_qubit[1])) # number=2
    c.append(cirq.H.on(input_qubit[1])) # number=14
    c.append(cirq.CNOT.on(input_qubit[3],input_qubit[1])) # number=20
    ...
    c.append(cirq.T.on(input_qubit[1])) # number=40
    c.append(cirq.T.on(input_qubit[1])) # number=32
    c.append(cirq.T.on(input_qubit[1])) # number=41
    ...
    c.append(cirq.CNOT.on(input_qubit[0],input_qubit[3])) # number=6
    c.append(cirq.H.on(input_qubit[3])) # number=26
    c.append(cirq.S.on(input_qubit[3])) # number=42
    c.append(cirq.S.on(input_qubit[3])) # number=43
    ...
    c.append(cirq.CZ.on(input_qubit[1],input_qubit[2])) # number=36
...
if __name__ == '__main__':
    ...
    writefile = open("startCirq_pragma_229.csv","w+")
