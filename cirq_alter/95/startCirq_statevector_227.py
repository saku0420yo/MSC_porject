...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.S.on(input_qubit[1])) # number=1
    c.append(cirq.S.on(input_qubit[1])) # number=44
    ...
    c.append(cirq.CNOT.on(input_qubit[1],input_qubit[2])) # number=74
    ...
    c.append(cirq.CZ.on(input_qubit[1],input_qubit[2])) # number=42
