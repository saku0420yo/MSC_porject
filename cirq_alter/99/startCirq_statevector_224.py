...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.T.on(input_qubit[1])) # number=57
    ...
    c.append(cirq.T.on(input_qubit[3])) # number=39
    ...
    c.append(cirq.S.on(input_qubit[0])) # number=46
    c.append(cirq.S.on(input_qubit[0])) # number=64
    ...
    c.append(cirq.CZ.on(input_qubit[0],input_qubit[1])) # number=19
    ...
    c.append(cirq.T.on(input_qubit[1])) # number=35
