...
def make_circuit()-> Program:
    ...
    prog += H(3) # number=37
    prog += H(3) # number=19
    prog += CZ(0,3) # number=75
    prog += H(3) # number=76
    prog += H(3) # number=38
    prog += CZ(0,3) # number=77
    prog += H(3) # number=78
    prog += H(3) # number=56
    prog += CZ(0,3) # number=79
    prog += H(3) # number=80
    prog += X(3) # number=67
    prog += CNOT(0,3) # number=68
    prog += H(3) # number=57
    prog += CZ(0,3) # number=81
    prog += H(3) # number=82
    prog += H(3) # number=39
    prog += H(3) # number=58
    prog += CNOT(0,3) # number=83
    prog += H(3) # number=84
    prog += H(3) # number=59
    prog += H(3) # number=20
