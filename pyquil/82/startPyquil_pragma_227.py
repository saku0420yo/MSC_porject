...
def make_circuit()-> Program:
    ...
    prog += H(3) # number=39
    prog += H(3) # number=48
    prog += CNOT(0,3) # number=59
    prog += H(3) # number=60
    prog += H(3) # number=49
    prog += H(3) # number=20
    prog += H(3) # number=30
    prog += CNOT(0,3) # number=61
    prog += H(3) # number=62
    prog += H(3) # number=31
    prog += H(2) # number=11
    prog += H(2) # number=63
    prog += CNOT(1,2) # number=70
    prog += H(2) # number=71
    prog += H(2) # number=64
    # circuit end
...
if __name__ == '__main__':
    ...
    writefile = open("startPyquil_pragma_227.csv","w")
